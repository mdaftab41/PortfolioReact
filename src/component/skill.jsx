...
function Skill() {
  ...
  return (
    ...
    <div className=" bg-zinc-950 bar">
      ...
      <div className="py-5 mx-8 mt-0 font-serif text-white md:mx-10 md:text-2xl lg:mx-36"  data-aos="fade-up">
        <p>
      ...
      <div className="container grid justify-center w-auto h-auto mx-6 bg-white rounded-lg md:grid-cols-2 md:justify-between md:h-auto md:mx-10 lg:mx-36">
