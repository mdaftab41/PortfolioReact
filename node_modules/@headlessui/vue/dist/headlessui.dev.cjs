...
var globalId = 0;
function useId() {
  let generateId = (0, import_vue4.inject)(GENERATE_ID, () => {
    return `${++globalId}`;
  });
  return generateId();
}
function provideUseId(fn) {
  (0, import_vue4.provide)(GENERATE_ID, fn);
}
...
function useResolveButtonType(data, refElement) {
  let type = (0, import_vue9.ref)(resolveType(data.value.type, data.value.as));
...
function _render({
  ...
  if (as === "template") {
    ...
    if (Object.keys(incomingProps).length > 0 || Object.keys(attrs).length > 0) {
      ...
      let cloned = (0, import_vue12.cloneVNode)(firstChild, mergedProps, true);
  ...
  return (0, import_vue12.h)(as, Object.assign({}, incomingProps, dataAttributes), {
    default: () => children
  });
}
function flattenFragments(children) {
  return children.flatMap((child) => {
    if (child.type === import_vue12.Fragment) {
...
// src/internal/hidden.ts
var Hidden = (0, import_vue13.defineComponent)({
  name: "Hidden",
  props: {
...
function useOpenClosed() {
  return (0, import_vue14.inject)(Context, null);
}
function useOpenClosedProvider(value) {
  (0, import_vue14.provide)(Context, value);
}
...
function useComboboxContext(component) {
  let context = (0, import_vue15.inject)(ComboboxContext, null);
  if (context === null) {
...
var VirtualProvider = (0, import_vue15.defineComponent)({
  name: "VirtualProvider",
  setup(_, { slots }) {
    let api = useComboboxContext("VirtualProvider");
    let padding = (0, import_vue15.computed)(() => {
    ...
    let options = (0, import_vue15.computed)(() => {
      var _a;
      return (_a = api.virtual.value) == null ? void 0 : _a.options;
    });
    let baseKey = (0, import_vue15.ref)(0);
    (0, import_vue15.watch)([options], () => {
      baseKey.value += 1;
    });
    (0, import_vue15.provide)(VirtualContext, api.virtual.value ? virtualizer : null);
    return () => {
      return [
        (0, import_vue15.h)(
          "div",
          ...
          virtualizer.value.getVirtualItems().map((item) => {
            return (0, import_vue15.cloneVNode)(
              slots.default({
...
var Combobox = (0, import_vue15.defineComponent)({
  name: "Combobox",
  ...
  setup(props, { slots, attrs, emit }) {
    let comboboxState = (0, import_vue15.ref)(1 /* Closed */);
    let labelRef = (0, import_vue15.ref)(null);
    let inputRef = (0, import_vue15.ref)(null);
    let buttonRef = (0, import_vue15.ref)(null);
    let optionsRef = (0, import_vue15.ref)(
      null
    );
    let optionsPropsRef = (0, import_vue15.ref)({
      static: false,
      hold: false
    });
    let options = (0, import_vue15.ref)([]);
    let activeOptionIndex = (0, import_vue15.ref)(null);
    let activationTrigger = (0, import_vue15.ref)(
      2 /* Other */
    );
    let defaultToFirstOption = (0, import_vue15.ref)(false);
    ...
    let mode = (0, import_vue15.computed)(() => props.multiple ? 1 /* Multi */ : 0 /* Single */);
    let nullable = (0, import_vue15.computed)(() => props.nullable);
    let [directValue, theirOnChange] = useControllable(
      (0, import_vue15.computed)(() => props.modelValue),
      (value2) => emit("update:modelValue", value2),
      (0, import_vue15.computed)(() => props.defaultValue)
    );
    let value = (0, import_vue15.computed)(
    ...
    function onChange(value2) {
      return match(mode.value, {
        ...
        [1 /* Multi */]: () => {
          let copy = (0, import_vue15.toRaw)(api.value.value).slice();
          let raw = (0, import_vue15.toRaw)(value2);
          let idx = copy.findIndex((value3) => api.compare(raw, (0, import_vue15.toRaw)(value3)));
          if (idx === -1) {
            copy.push(raw);
          } else {
            copy.splice(idx, 1);
    ...
    let virtualOptions = (0, import_vue15.computed)(() => {
      return void 0;
    });
    (0, import_vue15.watch)([virtualOptions], ([newOptions], [oldOptions]) => {
    ...
    let api = {
      ...
      defaultValue: (0, import_vue15.computed)(() => props.defaultValue),
      nullable,
      immediate: (0, import_vue15.computed)(() => {
        return false;
      }),
      virtual: (0, import_vue15.computed)(() => {
        return null;
      }),
      inputRef,
      labelRef,
      ...
      registerOption(id, dataRef) {
        let option = (0, import_vue15.reactive)({ id, dataRef });
        if (api.virtual.value) {
      ...
      isSelected(other) {
        return match(mode.value, {
          [0 /* Single */]: () => api.compare((0, import_vue15.toRaw)(api.value.value), (0, import_vue15.toRaw)(other)),
          [1 /* Multi */]: () => (0, import_vue15.toRaw)(api.value.value).some(
            (option) => api.compare((0, import_vue15.toRaw)(option), (0, import_vue15.toRaw)(other))
          )
        });
      },
      isActive(other) {
    ...
    useOutsideClick(
      ...
      () => api.closeCombobox(),
      (0, import_vue15.computed)(() => comboboxState.value === 0 /* Open */)
    );
    (0, import_vue15.provide)(ComboboxContext, api);
    ...
    let form = (0, import_vue15.computed)(() => {
      var _a;
...
var ComboboxLabel = (0, import_vue15.defineComponent)({
  name: "ComboboxLabel",
  props: {
...
var ComboboxButton = (0, import_vue15.defineComponent)({
  name: "ComboboxButton",
  props: {
  ...
  setup(props, { attrs, slots, expose }) {
    ...
    let type = useResolveButtonType(
      (0, import_vue15.computed)(() => ({ as: props.as, type: attrs.type })),
      api.buttonRef
    );
    return () => {
      var _a2, _b;
...
var ComboboxInput = (0, import_vue15.defineComponent)({
  name: "ComboboxInput",
  props: {
  ...
  setup(props, { emit, attrs, slots, expose }) {
    ...
    let ownerDocument = (0, import_vue15.computed)(() => getOwnerDocument(dom(api.inputRef)));
    ...
    let currentDisplayValue = (0, import_vue15.computed)(() => {
      var _a2;
    ...
    (0, import_vue15.onMounted)(() => {
      ...
      (0, import_vue15.watch)([api.comboboxState], ([newState], [oldState]) => {
    ...
    let isComposing = (0, import_vue15.ref)(false);
    ...
    let defaultValue = (0, import_vue15.computed)(() => {
      var _a2, _b, _c, _d;
...
var ComboboxOptions = (0, import_vue15.defineComponent)({
  ...
  setup(props, { attrs, slots, expose }) {
    ...
    let visible = (0, import_vue15.computed)(() => {
    ...
    useTreeWalker({
      container: (0, import_vue15.computed)(() => dom(api.optionsRef)),
      enabled: (0, import_vue15.computed)(() => api.comboboxState.value === 0 /* Open */),
      accept(node) {
    ...
    return () => {
      ...
      return render({
        ...
        slots: api.virtual.value && api.comboboxState.value === 0 /* Open */ ? {
          ...slots,
          default: () => [(0, import_vue15.h)(VirtualProvider, {}, slots.default)]
        } : slots,
        features: 1 /* RenderStrategy */ | 2 /* Static */,
...
var ComboboxOption = (0, import_vue15.defineComponent)({
  name: "ComboboxOption",
  props: {
  ...
  setup(props, { slots, attrs, expose }) {
    ...
    let internalOptionRef = (0, import_vue15.ref)(null);
    let disabled = (0, import_vue15.computed)(() => {
      return props.disabled;
    });
    expose({ el: internalOptionRef, $el: internalOptionRef });
    let active = (0, import_vue15.computed)(() => {
      var _a;
    ...
    let selected = (0, import_vue15.computed)(() => api.isSelected(props.value));
    let virtualizer = (0, import_vue15.inject)(VirtualContext, null);
    let dataRef = (0, import_vue15.computed)(() => ({
      disabled: props.disabled,
      value: props.value,
      domRef: internalOptionRef,
      order: (0, import_vue15.computed)(() => props.order)
    }));
    (0, import_vue15.onMounted)(() => api.registerOption(id, dataRef));
    (0, import_vue15.onUnmounted)(() => api.unregisterOption(id, active.value));
    (0, import_vue15.watchEffect)(() => {
...
function useTabDirection() {
  let direction = (0, import_vue17.ref)(0 /* Forwards */);
  ...
  (0, import_vue18.defineComponent)({
    ...
    props: {
      ...
      containers: {
        ...
        default: (0, import_vue18.ref)(/* @__PURE__ */ new Set())
      }
    },
    inheritAttrs: false,
    setup(props, { attrs, slots, expose }) {
      let container = (0, import_vue18.ref)(null);
      expose({ el: container, $el: container });
      let ownerDocument = (0, import_vue18.computed)(() => getOwnerDocument(container));
      let mounted = (0, import_vue18.ref)(false);
      (0, import_vue18.onMounted)(() => mounted.value = true);
      (0, import_vue18.onUnmounted)(() => mounted.value = false);
      useRestoreFocus(
        { ownerDocument },
        (0, import_vue18.computed)(() => mounted.value && Boolean(props.features & 16 /* RestoreFocus */))
      );
      let previousActiveElement = useInitialFocus(
        { ownerDocument, container, initialFocus: (0, import_vue18.computed)(() => props.initialFocus) },
        (0, import_vue18.computed)(() => mounted.value && Boolean(props.features & 2 /* InitialFocus */))
      );
      useFocusLock(
        {
          ownerDocument,
        ...
        (0, import_vue18.computed)(() => mounted.value && Boolean(props.features & 8 /* FocusLock */))
      );
      ...
      let recentlyUsedTabKey = (0, import_vue18.ref)(false);
      ...
      return () => {
        ...
        return (0, import_vue18.h)(import_vue18.Fragment, [
          Boolean(features & 4 /* TabLock */) && (0, import_vue18.h)(Hidden, {
            as: "button",
            type: "button",
...
function useRestoreElement(enabled) {
  let localHistory = (0, import_vue18.ref)(history.slice());
...
function useInitialFocus({
  ...
  let previousActiveElement = (0, import_vue18.ref)(null);
  let mounted = (0, import_vue18.ref)(false);
  (0, import_vue18.onMounted)(() => mounted.value = true);
  (0, import_vue18.onUnmounted)(() => mounted.value = false);
  (0, import_vue18.onMounted)(() => {
...
function useStore(store) {
  let state = (0, import_vue19.shallowRef)(store.getSnapshot());
...
function useDocumentOverflowLockedEffect(doc, shouldBeLocked, meta) {
  ...
  let locked = (0, import_vue20.computed)(() => {
...
function useInert(node, enabled = (0, import_vue21.ref)(true)) {
  (0, import_vue21.watchEffect)((onInvalidate) => {
    var _a;
    if (!enabled.value)
      return;
...
function useRootContainers({
  ...
  let mainTreeNodeRef = (0, import_vue22.ref)(null);
  ...
  return {
    ...
    MainTreeNode() {
      if (_mainTreeNodeRef != null)
        return null;
      return (0, import_vue22.h)(Hidden, { features: 4 /* Hidden */, ref: mainTreeNodeRef });
    }
  };
}
...
function usePortalRoot() {
  return (0, import_vue23.inject)(ForcePortalRootContext, false);
}
var ForcePortalRoot = (0, import_vue23.defineComponent)({
  ...
  setup(props, { slots, attrs }) {
    (0, import_vue23.provide)(ForcePortalRootContext, props.force);
    return () => {
...
function useStackContext() {
  return (0, import_vue24.inject)(StackContext, () => {
  });
}
function useStackProvider({
  ...
  (0, import_vue24.provide)(StackContext, notify);
}
...
function useDescriptionContext() {
  let context = (0, import_vue25.inject)(DescriptionContext, null);
  if (context === null) {
...
function useDescriptions({
  slot = (0, import_vue25.ref)({}),
  name = "Description",
  props = {}
} = {}) {
  let descriptionIds = (0, import_vue25.ref)([]);
  ...
  (0, import_vue25.provide)(DescriptionContext, { register, slot, name, props });
  return (0, import_vue25.computed)(
    () => descriptionIds.value.length > 0 ? descriptionIds.value.join(" ") : void 0
  );
}
var Description = (0, import_vue25.defineComponent)({
  name: "Description",
  props: {
  ...
  setup(myProps, { attrs, slots }) {
    ...
    (0, import_vue25.onMounted)(() => (0, import_vue25.onUnmounted)(context.register(id)));
    return () => {
      let { name = "Description", slot = (0, import_vue25.ref)({}), props = {} } = context;
...
function getCount(el) {
  var _a;
  return (_a = counter.get(el)) != null ? _a : 0;
}
...
var Portal = (0, import_vue26.defineComponent)({
  name: "Portal",
  props: {
    as: { type: [Object, String], default: "div" }
  },
  setup(props, { slots, attrs }) {
    let element = (0, import_vue26.ref)(null);
    let ownerDocument = (0, import_vue26.computed)(() => getOwnerDocument(element));
    let forcePortalRoot = usePortalRoot();
    let groupContext = (0, import_vue26.inject)(PortalGroupContext, null);
    let myTarget = (0, import_vue26.ref)(
    ...
    let parent = (0, import_vue26.inject)(PortalParentContext, null);
    let didRegister = false;
    let instance = (0, import_vue26.getCurrentInstance)();
    (0, import_vue26.watch)(element, () => {
      if (didRegister)
        return;
      if (!parent)
        return;
      ...
      if (!domElement)
        return;
      (0, import_vue26.onUnmounted)(parent.register(domElement), instance);
      didRegister = true;
    });
...
function useNestedPortals() {
  let parent = (0, import_vue26.inject)(PortalParentContext, null);
  let portals = (0, import_vue26.ref)([]);
  ...
  return [
    portals,
    (0, import_vue26.defineComponent)({
      name: "PortalWrapper",
      setup(_, { slots }) {
        (0, import_vue26.provide)(PortalParentContext, api);
        return () => {
          var _a;
...
var PortalGroup = (0, import_vue26.defineComponent)({
  name: "PortalGroup",
  props: {
    as: { type: [Object, String], default: "template" },
  ...
  setup(props, { attrs, slots }) {
    let api = (0, import_vue26.reactive)({
      resolveTarget() {
        return props.target;
      }
    });
    (0, import_vue26.provide)(PortalGroupContext, api);
    return () => {
...
function useDialogContext(component) {
  let context = (0, import_vue27.inject)(DialogContext, null);
  if (context === null) {
...
var Dialog = (0, import_vue27.defineComponent)({
  name: "Dialog",
  inheritAttrs: false,
  ...
  setup(props, { emit, attrs, slots, expose }) {
    ...
    let ready = (0, import_vue27.ref)(false);
    (0, import_vue27.onMounted)(() => {
      ready.value = true;
    });
    let didWarnOnRole = false;
    let role = (0, import_vue27.computed)(() => {
    ...
    let nestedDialogCount = (0, import_vue27.ref)(0);
    let usesOpenClosedState = useOpenClosed();
    let open = (0, import_vue27.computed)(() => {
      if (props.open === Missing && usesOpenClosedState !== null) {
        return (usesOpenClosedState.value & 1 /* Open */) === 1 /* Open */;
      }
      return props.open;
    });
    let internalDialogRef = (0, import_vue27.ref)(null);
    let ownerDocument = (0, import_vue27.computed)(() => getOwnerDocument(internalDialogRef));
    ...
    let dialogState = (0, import_vue27.computed)(
      () => !ready.value ? 1 /* Closed */ : open.value ? 0 /* Open */ : 1 /* Closed */
    );
    let enabled = (0, import_vue27.computed)(() => dialogState.value === 0 /* Open */);
    let hasNestedDialogs = (0, import_vue27.computed)(() => nestedDialogCount.value > 1);
    let hasParentDialog = (0, import_vue27.inject)(DialogContext, null) !== null;
    ...
    let {
      ...
      portals,
      defaultContainers: [(0, import_vue27.computed)(() => {
        var _a2;
        return (_a2 = api.panelRef.value) != null ? _a2 : internalDialogRef.value;
      })]
    });
    let position = (0, import_vue27.computed)(() => !hasNestedDialogs.value ? "leaf" : "parent");
    let isClosing = (0, import_vue27.computed)(
      () => usesOpenClosedState !== null ? (usesOpenClosedState.value & 4 /* Closing */) === 4 /* Closing */ : false
    );
    let inertOthersEnabled = (0, import_vue27.computed)(() => {
      if (hasParentDialog)
        return false;
      if (isClosing.value)
        return false;
    ...
    let resolveRootOfMainTreeNode = (0, import_vue27.computed)(() => {
      var _a2, _b2, _c;
    ...
    let inertParentDialogs = (0, import_vue27.computed)(() => {
      if (hasNestedDialogs.value)
        return true;
      return enabled.value;
    });
    let resolveRootOfParentDialog = (0, import_vue27.computed)(() => {
      var _a2, _b2, _c;
    ...
    useStackProvider({
      type: "Dialog",
      enabled: (0, import_vue27.computed)(() => dialogState.value === 0 /* Open */),
    ...
    let describedby = useDescriptions({
      ...
      slot: (0, import_vue27.computed)(() => ({ open: open.value }))
    });
    let titleId = (0, import_vue27.ref)(null);
    let api = {
      titleId,
      panelRef: (0, import_vue27.ref)(null),
      dialogState,
      setTitleId(id2) {
    ...
    (0, import_vue27.provide)(DialogContext, api);
    let outsideClickEnabled = (0, import_vue27.computed)(() => {
      if (!enabled.value)
        return false;
      if (hasNestedDialogs.value)
        return false;
    ...
    useOutsideClick(
      ...
      (event, target) => {
        event.preventDefault();
        api.close();
        (0, import_vue27.nextTick)(() => target == null ? void 0 : target.focus());
      },
      outsideClickEnabled
    );
    let escapeToCloseEnabled = (0, import_vue27.computed)(() => {
      if (hasNestedDialogs.value)
        return false;
    ...
    let scrollLockEnabled = (0, import_vue27.computed)(() => {
      if (isClosing.value)
        return false;
      if (dialogState.value !== 0 /* Open */)
        return false;
    ...
    (0, import_vue27.watchEffect)((onInvalidate) => {
      if (dialogState.value !== 0 /* Open */)
        return;
    ...
    return () => {
      ...
      return (0, import_vue27.h)(ForcePortalRoot, { force: true }, () => [
        (0, import_vue27.h)(
          Portal,
          () => (0, import_vue27.h)(
            PortalGroup,
        ...
        (0, import_vue27.h)(MainTreeNode)
      ]);
    };
  }
});
var DialogOverlay = (0, import_vue27.defineComponent)({
  name: "DialogOverlay",
  props: {
    as: { type: [Object, String], default: "div" },
    id: { type: String, default: null }
...
var DialogBackdrop = (0, import_vue27.defineComponent)({
  name: "DialogBackdrop",
  props: {
    as: { type: [Object, String], default: "div" },
    id: { type: String, default: null }
  ...
  setup(props, { attrs, slots, expose }) {
    ...
    let internalBackdropRef = (0, import_vue27.ref)(null);
...
var DialogPanel = (0, import_vue27.defineComponent)({
  name: "DialogPanel",
  props: {
    as: { type: [Object, String], default: "div" },
    id: { type: String, default: null }
...
var DialogTitle = (0, import_vue27.defineComponent)({
  name: "DialogTitle",
  props: {
  ...
  setup(props, { attrs, slots }) {
    ...
    (0, import_vue27.onMounted)(() => {
      api.setTitleId(id);
      (0, import_vue27.onUnmounted)(() => api.setTitleId(null));
    });
    return () => {
      let { ...theirProps } = props;
      let ourProps = { id };
...
function useDisclosureContext(component) {
  let context = (0, import_vue28.inject)(DisclosureContext, null);
  if (context === null) {
...
function useDisclosurePanelContext() {
  return (0, import_vue28.inject)(DisclosurePanelContext, null);
}
var Disclosure = (0, import_vue28.defineComponent)({
  name: "Disclosure",
  props: {
    as: { type: [Object, String], default: "template" },
  ...
  setup(props, { slots, attrs }) {
    let disclosureState = (0, import_vue28.ref)(
      props.defaultOpen ? 0 /* Open */ : 1 /* Closed */
    );
    let panelRef = (0, import_vue28.ref)(null);
    let buttonRef = (0, import_vue28.ref)(null);
    let api = {
      buttonId: (0, import_vue28.ref)(`headlessui-disclosure-button-${useId()}`),
      panelId: (0, import_vue28.ref)(`headlessui-disclosure-panel-${useId()}`),
      disclosureState,
      panel: panelRef,
      button: buttonRef,
      toggleDisclosure() {
    ...
    (0, import_vue28.provide)(DisclosureContext, api);
    useOpenClosedProvider(
...
var DisclosureButton = (0, import_vue28.defineComponent)({
  ...
  setup(props, { attrs, slots, expose }) {
    ...
    let isWithinPanel = (0, import_vue28.computed)(
    ...
    let internalButtonRef = (0, import_vue28.ref)(null);
...
var DisclosurePanel = (0, import_vue28.defineComponent)({
  ...
  setup(props, { attrs, slots, expose }) {
    ...
    (0, import_vue28.provide)(DisclosurePanelContext, api.panelId);
    let usesOpenClosedState = useOpenClosed();
...
function useTextValue(element) {
  let cacheKey = (0, import_vue29.ref)("");
  let cacheValue = (0, import_vue29.ref)("");
  return () => {
    let el = dom(element);
    if (!el)
      return "";
...
function useListboxContext(component) {
  let context = (0, import_vue30.inject)(ListboxContext, null);
  if (context === null) {
...
var Listbox = (0, import_vue30.defineComponent)({
  name: "Listbox",
  emits: { "update:modelValue": (_value) => true },
  props: {
    as: { type: [Object, String], default: "template" },
  ...
  inheritAttrs: false,
  setup(props, { slots, attrs, emit }) {
    let listboxState = (0, import_vue30.ref)(1 /* Closed */);
    let labelRef = (0, import_vue30.ref)(null);
    let buttonRef = (0, import_vue30.ref)(null);
    let optionsRef = (0, import_vue30.ref)(null);
    let options = (0, import_vue30.ref)([]);
    let searchQuery = (0, import_vue30.ref)("");
    let activeOptionIndex = (0, import_vue30.ref)(null);
    ...
    let mode = (0, import_vue30.computed)(() => props.multiple ? 1 /* Multi */ : 0 /* Single */);
    let [directValue, theirOnChange] = useControllable(
      (0, import_vue30.computed)(() => props.modelValue),
      (value2) => emit("update:modelValue", value2),
      (0, import_vue30.computed)(() => props.defaultValue)
    );
    let value = (0, import_vue30.computed)(
      () => directValue.value === void 0 ? match(mode.value, {
        [1 /* Multi */]: [],
        [0 /* Single */]: void 0
      }) : directValue.value
    ...
    let api = {
      ...
      orientation: (0, import_vue30.computed)(() => props.horizontal ? "horizontal" : "vertical"),
      labelRef,
      buttonRef,
      optionsRef,
      disabled: (0, import_vue30.computed)(() => props.disabled),
      options,
      searchQuery,
      activeOptionIndex,
      activationTrigger,
      ...
      select(value2) {
        ...
        theirOnChange(
          match(mode.value, {
            [0 /* Single */]: () => value2,
            [1 /* Multi */]: () => {
              let copy = (0, import_vue30.toRaw)(api.value.value).slice();
              let raw = (0, import_vue30.toRaw)(value2);
              let idx = copy.findIndex((value3) => api.compare(raw, (0, import_vue30.toRaw)(value3)));
              if (idx === -1) {
                copy.push(raw);
              } else {
                copy.splice(idx, 1);
    ...
    useOutsideClick(
      ...
      (0, import_vue30.computed)(() => listboxState.value === 0 /* Open */)
    );
    (0, import_vue30.provide)(ListboxContext, api);
    useOpenClosedProvider(
...
var ListboxLabel = (0, import_vue30.defineComponent)({
  name: "ListboxLabel",
  props: {
    as: { type: [Object, String], default: "label" },
    id: { type: String, default: null }
...
var ListboxButton = (0, import_vue30.defineComponent)({
  name: "ListboxButton",
  props: {
    as: { type: [Object, String], default: "button" },
    id: { type: String, default: null }
...
var ListboxOptions = (0, import_vue30.defineComponent)({
  name: "ListboxOptions",
  props: {
    as: { type: [Object, String], default: "ul" },
    static: { type: Boolean, default: false },
...
var ListboxOption = (0, import_vue30.defineComponent)({
  name: "ListboxOption",
  props: {
    as: { type: [Object, String], default: "li" },
    value: {
  ...
  setup(props, { slots, attrs, expose }) {
    ...
    let internalOptionRef = (0, import_vue30.ref)(null);
    expose({ el: internalOptionRef, $el: internalOptionRef });
    ...
    let selected = (0, import_vue30.computed)(
      () => match(api.mode.value, {
        [0 /* Single */]: () => api.compare((0, import_vue30.toRaw)(api.value.value), (0, import_vue30.toRaw)(props.value)),
        [1 /* Multi */]: () => (0, import_vue30.toRaw)(api.value.value).some(
          (value) => api.compare((0, import_vue30.toRaw)(value), (0, import_vue30.toRaw)(props.value))
        )
      })
    );
    let isFirstSelected = (0, import_vue30.computed)(() => {
      return match(api.mode.value, {
        [1 /* Multi */]: () => {
          var _a2;
          let currentValues = (0, import_vue30.toRaw)(api.value.value);
          return ((_a2 = api.options.value.find(
            (option) => currentValues.some((value) => api.compare((0, import_vue30.toRaw)(value), (0, import_vue30.toRaw)(option.dataRef.value)))
    ...
    (0, import_vue30.onMounted)(() => api.registerOption(id, dataRef));
    (0, import_vue30.onUnmounted)(() => api.unregisterOption(id));
    (0, import_vue30.onMounted)(() => {
      (0, import_vue30.watch)(
...
function useMenuContext(component) {
  let context = (0, import_vue31.inject)(MenuContext, null);
  if (context === null) {
...
var Menu = (0, import_vue31.defineComponent)({
  name: "Menu",
  props: { as: { type: [Object, String], default: "template" } },
  setup(props, { slots, attrs }) {
    let menuState = (0, import_vue31.ref)(1 /* Closed */);
    let buttonRef = (0, import_vue31.ref)(null);
    let itemsRef = (0, import_vue31.ref)(null);
    let items = (0, import_vue31.ref)([]);
    let searchQuery = (0, import_vue31.ref)("");
    let activeItemIndex = (0, import_vue31.ref)(null);
    let activationTrigger = (0, import_vue31.ref)(
      1 /* Other */
    );
    function adjustOrderedState(adjustment = (i) => i) {
    ...
    useOutsideClick(
      ...
      (0, import_vue31.computed)(() => menuState.value === 0 /* Open */)
    );
    (0, import_vue31.provide)(MenuContext, api);
    useOpenClosedProvider(
...
var MenuButton = (0, import_vue31.defineComponent)({
  name: "MenuButton",
  props: {
    disabled: { type: Boolean, default: false },
    as: { type: [Object, String], default: "button" },
...
var MenuItems = (0, import_vue31.defineComponent)({
  name: "MenuItems",
  props: {
    as: { type: [Object, String], default: "div" },
    static: { type: Boolean, default: false },
  ...
  setup(props, { attrs, slots, expose }) {
    ...
    let searchDebounce = (0, import_vue31.ref)(null);
    expose({ el: api.itemsRef, $el: api.itemsRef });
    useTreeWalker({
      container: (0, import_vue31.computed)(() => dom(api.itemsRef)),
      enabled: (0, import_vue31.computed)(() => api.menuState.value === 0 /* Open */),
      accept(node) {
...
var MenuItem = (0, import_vue31.defineComponent)({
  name: "MenuItem",
  inheritAttrs: false,
  props: {
    as: { type: [Object, String], default: "template" },
  ...
  setup(props, { slots, attrs, expose }) {
    ...
    let internalItemRef = (0, import_vue31.ref)(null);
    expose({ el: internalItemRef, $el: internalItemRef });
    let active = (0, import_vue31.computed)(() => {
    ...
    let dataRef = (0, import_vue31.computed)(() => ({
      disabled: props.disabled,
      get textValue() {
        return getTextValue2();
      },
    ...
    (0, import_vue31.onMounted)(() => api.registerItem(id, dataRef));
    (0, import_vue31.onUnmounted)(() => api.unregisterItem(id));
...
function usePopoverContext(component) {
  let context = (0, import_vue32.inject)(PopoverContext, null);
  if (context === null) {
...
function usePopoverGroupContext() {
  return (0, import_vue32.inject)(PopoverGroupContext, null);
}
var PopoverPanelContext = Symbol("PopoverPanelContext");
function usePopoverPanelContext() {
  return (0, import_vue32.inject)(PopoverPanelContext, null);
}
var Popover = (0, import_vue32.defineComponent)({
  name: "Popover",
  inheritAttrs: false,
  props: {
    as: { type: [Object, String], default: "div" }
  ...
  setup(props, { slots, attrs, expose }) {
    var _a;
    let internalPopoverRef = (0, import_vue32.ref)(null);
    expose({ el: internalPopoverRef, $el: internalPopoverRef });
    let popoverState = (0, import_vue32.ref)(1 /* Closed */);
    let button = (0, import_vue32.ref)(null);
    let beforePanelSentinel = (0, import_vue32.ref)(null);
    let afterPanelSentinel = (0, import_vue32.ref)(null);
    let panel = (0, import_vue32.ref)(null);
    let ownerDocument = (0, import_vue32.computed)(() => getOwnerDocument(internalPopoverRef));
    let isPortalled = (0, import_vue32.computed)(() => {
      var _a2, _b;
      if (!dom(button))
        return false;
      if (!dom(panel))
    ...
    let api = {
      popoverState,
      buttonId: (0, import_vue32.ref)(null),
      panelId: (0, import_vue32.ref)(null),
      panel,
      button,
      isPortalled,
      beforePanelSentinel,
    ...
    (0, import_vue32.provide)(PopoverContext, api);
    useOpenClosedProvider(
      (0, import_vue32.computed)(
    ...
    (0, import_vue32.watchEffect)(() => registerPopover == null ? void 0 : registerPopover(registerBag));
    useEventListener(
      (_a = ownerDocument.value) == null ? void 0 : _a.defaultView,
      "focus",
      (event) => {
    ...
    useOutsideClick(
      ...
      (0, import_vue32.computed)(() => popoverState.value === 0 /* Open */)
    );
    return () => {
      ...
      return (0, import_vue32.h)(import_vue32.Fragment, [
        ...
        (0, import_vue32.h)(root.MainTreeNode)
      ]);
    };
  }
});
var PopoverButton = (0, import_vue32.defineComponent)({
  name: "PopoverButton",
  props: {
    as: { type: [Object, String], default: "button" },
    disabled: { type: [Boolean], default: false },
  ...
  setup(props, { attrs, slots, expose }) {
    ...
    let ownerDocument = (0, import_vue32.computed)(() => getOwnerDocument(api.button));
    ...
    let isWithinPanel = (0, import_vue32.computed)(
      () => panelContext === null ? false : panelContext.value === api.panelId.value
    );
    let elementRef = (0, import_vue32.ref)(null);
    ...
    return () => {
      ...
      return (0, import_vue32.h)(import_vue32.Fragment, [
        ...
        visible && !isWithinPanel.value && api.isPortalled.value && (0, import_vue32.h)(Hidden, {
          id: sentinelId,
          features: 2 /* Focusable */,
          "data-headlessui-focus-guard": true,
          as: "button",
...
var PopoverOverlay = (0, import_vue32.defineComponent)({
  name: "PopoverOverlay",
  props: {
    as: { type: [Object, String], default: "div" },
    static: { type: Boolean, default: false },
  ...
  setup(props, { attrs, slots }) {
    ...
    let usesOpenClosedState = useOpenClosed();
    let visible = (0, import_vue32.computed)(() => {
      if (usesOpenClosedState !== null) {
        return (usesOpenClosedState.value & 1 /* Open */) === 1 /* Open */;
      }
...
var PopoverPanel = (0, import_vue32.defineComponent)({
  name: "PopoverPanel",
  props: {
    as: { type: [Object, String], default: "div" },
    static: { type: Boolean, default: false },
  ...
  setup(props, { attrs, slots, expose }) {
    ...
    let ownerDocument = (0, import_vue32.computed)(() => getOwnerDocument(api.panel));
    ...
    (0, import_vue32.provide)(PopoverPanelContext, api.panelId);
    (0, import_vue32.watchEffect)(() => {
      var _a2, _b;
      if (!focus)
        return;
      ...
      return render({
        ...
        slots: {
          ...
          default: (...args) => {
            var _a2;
            return [
              (0, import_vue32.h)(import_vue32.Fragment, [
                visible.value && api.isPortalled.value && (0, import_vue32.h)(Hidden, {
...
var PopoverGroup = (0, import_vue32.defineComponent)({
  name: "PopoverGroup",
  inheritAttrs: false,
  props: {
    as: { type: [Object, String], default: "div" }
  ...
  setup(props, { attrs, slots, expose }) {
    let groupRef = (0, import_vue32.ref)(null);
    let popovers = (0, import_vue32.shallowRef)([]);
    let ownerDocument = (0, import_vue32.computed)(() => getOwnerDocument(groupRef));
    ...
    (0, import_vue32.provide)(PopoverGroupContext, {
      registerPopover,
      unregisterPopover,
...
function useLabelContext() {
  let context = (0, import_vue33.inject)(LabelContext, null);
  if (context === null) {
...
function useLabels({
  ...
  let labelIds = (0, import_vue33.ref)([]);
  function register(value) {
  ...
  (0, import_vue33.provide)(LabelContext, { register, slot, name, props });
  return (0, import_vue33.computed)(() => labelIds.value.length > 0 ? labelIds.value.join(" ") : void 0);
}
var Label = (0, import_vue33.defineComponent)({
  name: "Label",
  props: {
    as: { type: [Object, String], default: "label" },
  ...
  setup(myProps, { slots, attrs }) {
    ...
    (0, import_vue33.onMounted)(() => (0, import_vue33.onUnmounted)(context.register(id)));
    return () => {
      let { name = "Label", slot = {}, props = {} } = context;
      let { passive, ...theirProps } = myProps;
      let ourProps = {
        ...Object.entries(props).reduce(
          (acc, [key, value]) => Object.assign(acc, { [key]: (0, import_vue33.unref)(value) }),
          {}
        ),
        id
      };
...
function useRadioGroupContext(component) {
  let context = (0, import_vue34.inject)(RadioGroupContext, null);
  if (context === null) {
...
var RadioGroup = (0, import_vue34.defineComponent)({
  name: "RadioGroup",
  emits: { "update:modelValue": (_value) => true },
  props: {
    as: { type: [Object, String], default: "div" },
  ...
  setup(props, { emit, attrs, slots, expose }) {
    ...
    let radioGroupRef = (0, import_vue34.ref)(null);
    let options = (0, import_vue34.ref)([]);
    ...
    let [value, theirOnChange] = useControllable(
      ...
      (value2) => emit("update:modelValue", value2),
      (0, import_vue34.computed)(() => props.defaultValue)
    );
    let api = {
      options,
      value,
      disabled: (0, import_vue34.computed)(() => props.disabled),
      firstOption: (0, import_vue34.computed)(
      ...
      containsCheckedOption: (0, import_vue34.computed)(
        () => options.value.some(
          (option) => api.compare((0, import_vue34.toRaw)(option.propsRef.value), (0, import_vue34.toRaw)(props.modelValue))
        )
      ),
      compare(a, z) {
        if (typeof props.by === "string") {
      ...
      change(nextValue) {
        ...
        if (props.disabled)
          return false;
        if (api.compare((0, import_vue34.toRaw)(value.value), (0, import_vue34.toRaw)(nextValue)))
          return false;
        let nextOption = (_a2 = options.value.find(
          (option) => api.compare((0, import_vue34.toRaw)(option.propsRef.value), (0, import_vue34.toRaw)(nextValue))
    ...
    (0, import_vue34.provide)(RadioGroupContext, api);
    useTreeWalker({
      container: (0, import_vue34.computed)(() => dom(radioGroupRef)),
      accept(node) {
...
var RadioGroupOption = (0, import_vue34.defineComponent)({
  ...
  setup(props, { attrs, slots, expose }) {
    ...
    let labelledby = useLabels({ name: "RadioGroupLabel" });
    let describedby = useDescriptions({ name: "RadioGroupDescription" });
    let optionRef = (0, import_vue34.ref)(null);
    let propsRef = (0, import_vue34.computed)(() => ({ value: props.value, disabled: props.disabled }));
    let state = (0, import_vue34.ref)(1 /* Empty */);
    expose({ el: optionRef, $el: optionRef });
    let element = (0, import_vue34.computed)(() => dom(optionRef));
    (0, import_vue34.onMounted)(() => api.registerOption({ id, element, propsRef }));
    (0, import_vue34.onUnmounted)(() => api.unregisterOption(id));
    let isFirstOption = (0, import_vue34.computed)(() => {
      var _a2;
      return ((_a2 = api.firstOption.value) == null ? void 0 : _a2.id) === id;
    });
    let disabled = (0, import_vue34.computed)(() => api.disabled.value || props.disabled);
    let checked = (0, import_vue34.computed)(() => api.compare((0, import_vue34.toRaw)(api.value.value), (0, import_vue34.toRaw)(props.value)));
    let tabIndex = (0, import_vue34.computed)(() => {
      if (disabled.value)
        return -1;
      if (checked.value)
        return 0;
...
var SwitchGroup = (0, import_vue35.defineComponent)({
  name: "SwitchGroup",
  props: {
    as: { type: [Object, String], default: "template" }
  },
  setup(props, { slots, attrs }) {
    let switchRef = (0, import_vue35.ref)(null);
    let labelledby = useLabels({
      name: "SwitchLabel",
      props: {
        htmlFor: (0, import_vue35.computed)(() => {
          var _a;
    ...
    (0, import_vue35.provide)(GroupContext, api);
    return () => render({ theirProps: props, ourProps: {}, slot: {}, slots, attrs, name: "SwitchGroup" });
  }
});
var Switch = (0, import_vue35.defineComponent)({
  name: "Switch",
  emits: { "update:modelValue": (_value) => true },
  props: {
    as: { type: [Object, String], default: "button" },
  ...
  setup(props, { emit, attrs, slots, expose }) {
    ...
    let api = (0, import_vue35.inject)(GroupContext, null);
    let [checked, theirOnChange] = useControllable(
      (0, import_vue35.computed)(() => props.modelValue),
      (value) => emit("update:modelValue", value),
      (0, import_vue35.computed)(() => props.defaultChecked)
    );
    function toggle() {
      theirOnChange(!checked.value);
    }
    let internalSwitchRef = (0, import_vue35.ref)(null);
    ...
    let form = (0, import_vue35.computed)(() => {
      var _a2, _b;
    ...
    return () => {
      ...
      return (0, import_vue35.h)(import_vue35.Fragment, [
        name != null && checked.value != null ? (0, import_vue35.h)(
          Hidden,
          compact({
            features: 4 /* Hidden */,
            as: "input",
...
var FocusSentinel = (0, import_vue36.defineComponent)({
  props: {
    onFocus: {
      type: Function,
      required: true
  ...
  setup(props) {
    let enabled = (0, import_vue36.ref)(true);
    return () => {
      if (!enabled.value)
        return null;
      return (0, import_vue36.h)(Hidden, {
        as: "button",
        type: "button",
        features: 2 /* Focusable */,
        onFocus(event) {
...
function useTabsContext(component) {
  let context = (0, import_vue37.inject)(TabsContext, null);
  if (context === null) {
...
var TabGroup = (0, import_vue37.defineComponent)({
  name: "TabGroup",
  emits: {
    change: (_index) => true
  },
  ...
  setup(props, { slots, attrs, emit }) {
    var _a;
    let selectedIndex = (0, import_vue37.ref)(
      (_a = props.selectedIndex) != null ? _a : props.defaultIndex
    );
    let tabs = (0, import_vue37.ref)([]);
    let panels = (0, import_vue37.ref)([]);
    let isControlled = (0, import_vue37.computed)(() => props.selectedIndex !== null);
    let realSelectedIndex = (0, import_vue37.computed)(
    ...
    let api = {
      selectedIndex: (0, import_vue37.computed)(() => {
        var _a2, _b;
        return (_b = (_a2 = selectedIndex.value) != null ? _a2 : props.defaultIndex) != null ? _b : null;
      }),
      orientation: (0, import_vue37.computed)(() => props.vertical ? "vertical" : "horizontal"),
      activation: (0, import_vue37.computed)(() => props.manual ? "manual" : "auto"),
      tabs,
      panels,
    ...
    (0, import_vue37.provide)(TabsContext, api);
    let SSRCounter = (0, import_vue37.ref)({ tabs: [], panels: [] });
    let mounted = (0, import_vue37.ref)(false);
    (0, import_vue37.onMounted)(() => {
      mounted.value = true;
    });
    (0, import_vue37.provide)(
      TabsSSRContext,
      (0, import_vue37.computed)(() => mounted.value ? null : SSRCounter.value)
    );
    let incomingSelectedIndex = (0, import_vue37.computed)(() => props.selectedIndex);
    (0, import_vue37.onMounted)(() => {
    ...
    return () => {
      ...
      return (0, import_vue37.h)(import_vue37.Fragment, [
        tabs.value.length <= 0 && (0, import_vue37.h)(FocusSentinel, {
          onFocus: () => {
...
var TabList = (0, import_vue37.defineComponent)({
  name: "TabList",
  props: {
    as: { type: [Object, String], default: "div" }
  },
...
var Tab = (0, import_vue37.defineComponent)({
  name: "Tab",
  props: {
    as: { type: [Object, String], default: "button" },
    disabled: { type: [Boolean], default: false },
  ...
  setup(props, { attrs, slots, expose }) {
    ...
    let internalTabRef = (0, import_vue37.ref)(null);
    expose({ el: internalTabRef, $el: internalTabRef });
    (0, import_vue37.onMounted)(() => api.registerTab(internalTabRef));
    (0, import_vue37.onUnmounted)(() => api.unregisterTab(internalTabRef));
    let SSRContext = (0, import_vue37.inject)(TabsSSRContext);
    let mySSRIndex = (0, import_vue37.computed)(() => {
      if (SSRContext.value) {
    ...
    let myIndex = (0, import_vue37.computed)(() => {
      let myIndex2 = api.tabs.value.indexOf(internalTabRef);
      if (myIndex2 === -1)
        return mySSRIndex.value;
      return myIndex2;
    });
    let selected = (0, import_vue37.computed)(() => myIndex.value === api.selectedIndex.value);
    ...
    let ready = (0, import_vue37.ref)(false);
    ...
    let type = useResolveButtonType(
      (0, import_vue37.computed)(() => ({ as: props.as, type: attrs.type })),
      internalTabRef
    );
    return () => {
      var _a2, _b;
      let slot = { selected: selected.value, disabled: (_a2 = props.disabled) != null ? _a2 : false };
      let { ...theirProps } = props;
      let ourProps = {
        ref: internalTabRef,
        onKeydown: handleKeyDown,
...
var TabPanels = (0, import_vue37.defineComponent)({
  name: "TabPanels",
  props: {
    as: { type: [Object, String], default: "div" }
  },
...
var TabPanel = (0, import_vue37.defineComponent)({
  name: "TabPanel",
  props: {
    as: { type: [Object, String], default: "div" },
    static: { type: Boolean, default: false },
  ...
  setup(props, { attrs, slots, expose }) {
    ...
    let internalPanelRef = (0, import_vue37.ref)(null);
    expose({ el: internalPanelRef, $el: internalPanelRef });
    (0, import_vue37.onMounted)(() => api.registerPanel(internalPanelRef));
    (0, import_vue37.onUnmounted)(() => api.unregisterPanel(internalPanelRef));
    let SSRContext = (0, import_vue37.inject)(TabsSSRContext);
    let mySSRIndex = (0, import_vue37.computed)(() => {
      if (SSRContext.value) {
    ...
    return () => {
      ...
      if (!selected.value && props.unmount && !props.static) {
        return (0, import_vue37.h)(Hidden, { as: "span", "aria-hidden": true, ...ourProps });
      }
      return render({
        ourProps,
        theirProps,
...
function hasTransitionContext() {
  return (0, import_vue38.inject)(TransitionContext, null) !== null;
}
function useTransitionContext() {
  let context = (0, import_vue38.inject)(TransitionContext, null);
  if (context === null) {
...
function useParentNesting() {
  let context = (0, import_vue38.inject)(NestingContext, null);
  if (context === null) {
    throw new Error("A <TransitionChild /> is used but it is missing a parent <TransitionRoot />.");
  }
  return context;
...
function useNesting(done) {
  let transitionableChildren = (0, import_vue38.ref)([]);
  let mounted = (0, import_vue38.ref)(false);
  (0, import_vue38.onMounted)(() => mounted.value = true);
  (0, import_vue38.onUnmounted)(() => mounted.value = false);
...
var TransitionChild = (0, import_vue38.defineComponent)({
  props: {
    as: { type: [Object, String], default: "div" },
  ...
  setup(props, { emit, attrs, slots, expose }) {
    let transitionStateFlags = (0, import_vue38.ref)(0);
    ...
    let container = (0, import_vue38.ref)(null);
    let strategy = (0, import_vue38.computed)(() => props.unmount ? 0 /* Unmount */ : 1 /* Hidden */);
    expose({ el: container, $el: container });
    let { show, appear } = useTransitionContext();
    let { register, unregister } = useParentNesting();
    let state = (0, import_vue38.ref)(show.value ? "visible" /* Visible */ : "hidden" /* Hidden */);
    ...
    (0, import_vue38.onMounted)(() => {
      ...
      (0, import_vue38.onUnmounted)(unregister2);
    });
    (0, import_vue38.watchEffect)(() => {
    ...
    (0, import_vue38.provide)(NestingContext, nesting);
    useOpenClosedProvider(
      (0, import_vue38.computed)(
        () => match(state.value, {
    ...
    return () => {
      ...
      let theirProps = {
        ...
        ...appear.value && show.value && env.isServer ? {
          ...
          class: (0, import_vue38.normalizeClass)([
            attrs.class,
...
var TransitionRoot = (0, import_vue38.defineComponent)({
  inheritAttrs: false,
  props: {
    as: { type: [Object, String], default: "div" },
    show: { type: [Boolean], default: null },
  ...
  setup(props, { emit, attrs, slots }) {
    let usesOpenClosedState = useOpenClosed();
    let show = (0, import_vue38.computed)(() => {
    ...
    let initial = (0, import_vue38.ref)(true);
    let transitionBag = {
      show,
      appear: (0, import_vue38.computed)(() => props.appear || !initial.value)
    };
    (0, import_vue38.onMounted)(() => {
      (0, import_vue38.watchEffect)(() => {
        initial.value = false;
    ...
    (0, import_vue38.provide)(NestingContext, nestingBag);
    (0, import_vue38.provide)(TransitionContext, transitionBag);
    return () => {
